...
config_rows = [
    ...
    ("MODEL_VERSION", 3, "Increment after materially changing ratings or pricing assumptions.", "Organizer"),
    ...
    ("REBOUND_LINE_QUANTILE", 0.62, "Rebound line percentile; higher makes the offered line harder to clear.", "Organizer"),
    ("ASSIST_LINE_QUANTILE", 0.66, "Assist line percentile; higher makes the offered line harder to clear.", "Organizer"),
    ("THREES_LINE_QUANTILE", 0.62, "Made-three line percentile; higher makes the offered line harder to clear.", "Organizer"),
    ("POINTS_LINE_QUANTILE", 0.55, "Points line percentile; higher makes the offered line harder to clear.", "Organizer"),
    ("COMBO_LINE_QUANTILE", 0.58, "Combo-prop line percentile; higher makes the offered line harder to clear.", "Organizer"),
