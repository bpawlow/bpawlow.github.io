...
config_rows = [
    ...
    ("MODEL_VERSION", 5, "Increment after materially changing ratings or pricing assumptions.", "Organizer"),
    ...
    ("POINTS_LINE_OFFSET", 0, "Whole-number adjustment added to every points player line; allowed range -5 to 5.", "Organizer"),
    ("REBOUNDS_LINE_OFFSET", 0, "Whole-number adjustment added to every rebounds player line; allowed range -5 to 5.", "Organizer"),
    ("ASSISTS_LINE_OFFSET", 0, "Whole-number adjustment added to every assists player line; allowed range -5 to 5.", "Organizer"),
    ("THREES_LINE_OFFSET", 0, "Whole-number adjustment added to every made-threes player line; allowed range -5 to 5.", "Organizer"),
    ("PR_LINE_OFFSET", 0, "Whole-number adjustment added to every points-plus-rebounds line; allowed range -10 to 10.", "Organizer"),
    ("PA_LINE_OFFSET", 0, "Whole-number adjustment added to every points-plus-assists line; allowed range -10 to 10.", "Organizer"),
    ("RA_LINE_OFFSET", 0, "Whole-number adjustment added to every rebounds-plus-assists line; allowed range -10 to 10.", "Organizer"),
    ("PRA_LINE_OFFSET", 0, "Whole-number adjustment added to every points-plus-rebounds-plus-assists line; allowed range -15 to 15.", "Organizer"),
